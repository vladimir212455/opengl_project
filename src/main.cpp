...
int main()
{
   ...
   glEnable(GL_DEPTH_TEST);
    ...
    Shader ourShader("/home/popik/OpenGL/shaders/obj.vs", "/home/popik/OpenGL/shaders/obj.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        projection = glm::perspective(glm::radians(((float)(45))), (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
